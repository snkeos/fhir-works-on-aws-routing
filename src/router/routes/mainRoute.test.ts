...
describe('Routing with out multi tenancy: GET /patient', () => {
    beforeAll(async () => {
    ...
    it(`For ${resourceType} it should return 200`, async done => {
        request(server)
            .get(`/${resourceType}`)
            .expect(200)
            .end((err, res) => {
    ...
    it(`For a specified ${resourceType} id should return 200.`, async done => {
        request(server)
...
describe('Routing with multi tenancy (basic): GET /{tenantid}/patient/{id}', () => {
    beforeAll(async () => {
        server = await createServer(
            {
                enabled: true,
    ...
    it('Regression for the Default tenant it should always return 200 regardless which tenantid is stored in the token', async done => {
    ...
    it('Also for a specified tenant should return 200 regardless which tenantid is stored in the token.', async done => {
...
describe('Routing with multi tenancy (including: token based tenant access control): GET /{tenantid}/patient/{id}', () => {
    beforeAll(async () => {
        server = await createServer(
            {
                enabled: true,
    ...
    it('Post: For Default tenant should return 201 regardless which tenantid is stored in the token', async done => {
        const tenantId: string = 'DEFAULT';
        request(server)
    ...
    it('Put: For Default tenant should return 200 regardless which tenantid is stored in the token', async done => {
        const tenantId: string = 'DEFAULT';
        request(server)
    ...
    it('Patch: For Default tenant should return 200 regardless which tenantid is stored in the token', async done => {
        const tenantId: string = 'DEFAULT';
        request(server)
    ...
    it('For Default tenant should return 200 regardless which tenantid is stored in the token', async done => {
        const tenantId: string = 'DEFAULT';
        request(server)
            .get(`/${tenantId}/${resourceType}/${resourceId}`)
            // .expect('Content-Type', /json/)
    ...
    it('For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
    ...
    it('type _history: For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
    ...
    it('instance_history: For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
    ...
    it('version_instance_history: For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
    ...
    it('For a specified tenant should return 401 if the url tenant id of does not match with the one, which is stored in the token', async done => {
        const tenantId: string = '1234567890';
        request(server)
            .get(`/${tenantId}/${resourceType}/${resourceId}`)
            // .expect('Content-Type', /json/)
...
describe('Routing with multi tenancy (including: tenant type url, token based tenant access control): GET /tenant/{tenantid}/patient/{id}', () => {
    beforeAll(async () => {
        server = await createServer(
            {
                enabled: true,
    ...
    it('Post: For a specified tenant should return 201 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
    ...
    it('Put: For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
    ...
    it('Patch: For a specified tenant should return 200 if the url tenant id of matches with the one, which is stored in the token.', async done => {
        const tenantId: string = '915b76f7-8744-4010-bd31-a1e4c0d9fc64';
        request(server)
